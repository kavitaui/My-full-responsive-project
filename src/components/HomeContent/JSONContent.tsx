export const JSONContent = {
  Myitems: [
    {
      ...
      title: 'User Friendly',
      subtitle:
        'Most probably the best dashboard design for your business you can try.',
  ...
  MyIcons: [
    ...
    },
    {
      ...
      title: 'Cloud Storage',
      subtitle:
        'Cloud based storage for your data backup just log in with your mail account from play store and using whatever you want for your business purpose orem ipsum dummy.',
      imageClass: 'PiCloud',
      color: 'linear-gradient(44.44deg, #ED2775 7.79%, #FF7448 94.18%)',
    },
  ],
  MyFeatureItems: [
    ...
    },
    {
      ...
      subtitle:
        'Just log in with your mail account from play store and using whatever you want for your able business purpose.',
      imageClass: 'RiSecurePaymentLine',
      color: 'linear-gradient(44.44deg, #3F75FF 7.79%, #4ADEFF 94.18%)',
    },

    {
      ...
      imageClass: 'PiCloud',
      color:
        'linear-gradient(43.32deg, #6A55F8 14.73%, #CA48F6 86.35%, #CA48F6 86.35%)',
    },
    {
      id: 6,
